...
const Resume = () => {
  const resumeexperienceData: IListItem[] = [
    ...
    { id: 7, from: 2015, to: 2018, title: "FrieslandCampina", address: "Budapest, Hungary", text: "Packing assistant. My job was to prepare production to be able to transport the final destination by track. Assist and manage the packages." },
  ];
